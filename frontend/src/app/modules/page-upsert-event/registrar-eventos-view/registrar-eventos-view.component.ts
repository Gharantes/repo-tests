...
import { IRegistrarEvent } from '@synergia-frontend/interfaces';
...
export class RegistrarEventosViewComponent
  extends AbsClassInsertView<IRegistrarEvent>
  implements AfterViewInit
{
  @Output() goToParentPageEvent = new EventEmitter<void>();
  @Output() registrarEntidadeEvent = new EventEmitter<IRegistrarEvent>();
  @Input() populateForm!: Subject<IRegistrarEvent | null>;
  ...
  public readonly form = this.fb.group<ControlsOf<IRegistrarEvent>>({
  ...
  override mapFormData(
    v: Partial<IRegistrarEvent>
  ): IRegistrarEvent | null {
  ...
  private fillForm(res: IRegistrarEvent) {
