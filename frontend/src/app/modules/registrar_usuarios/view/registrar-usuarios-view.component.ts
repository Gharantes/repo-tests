...
extends AbsClassInsertView<IUpsertAccount>
implements AfterViewInit
{
  @Output() registrarEntidadeEvent = new EventEmitter<IUpsertAccount>();
  @Output() goToParentPageEvent = new EventEmitter<void>;
  @Input() populateForm!: Subject<IUpsertAccount | null>;
  ...
  public form = this.fb.group<ControlsOf<IUpsertAccount>>({
  ...
  override mapFormData(v: Partial<IUpsertAccount>): IUpsertAccount | null {
  ...
  voltar() {
    return this.routingService.goTo(this.routingService.goToListAccounts());
  }
