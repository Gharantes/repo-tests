...
export class PageListProjectsResourceService {
    ...
    public deleteProject(idProject: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/api/page-list-projects/delete/${this.configuration.encodeParam({name: "idProject", value: idProject, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64"})}`;
    ...
    public listProjects(idTenant: number, idAccount: number, text?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/api/page-list-projects/list-projects`;
