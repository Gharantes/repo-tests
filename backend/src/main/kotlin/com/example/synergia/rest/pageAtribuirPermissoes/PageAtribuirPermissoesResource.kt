package com.example.synergia.rest.pageAtribuirPermissoes
...
import com.example.synergia.services.PageListarPermissoesService
...
@RestController
@RequestMapping("/api/atribuir-permissoes")
class
PageAtribuirPermissoesResource (
