# [Atividade] Analise de vulnerabilidade de sistema

Faça uma análise do seu sistema do TCC ou Proex;

use o prompt abaixo para auditar o sistema mais facilmente, o mesmo irá gerar um relatório que deverá ser entregue nesta atividade como comprovação da atividade.

Da mesma forma escreva um documento em grupo explicando como resolver as vulnerabilidades encontradas.
